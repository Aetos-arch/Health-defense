...
Au sein d'un univers moderne, apocalyptique, des personnes infectés tentent d'aller dans un bunker de gens sains.
...
Pour avoir plus d'informations sur les tourelles, infectés et statuts : vous pouvez cliquer sur les boutons "Info" sous les tourelles, et cliquer sur les différentes images des infectés et statuts.
